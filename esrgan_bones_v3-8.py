...
log_wandb = True
if log_wandb:
    wandb.init(project="esrgan_bones_3.7", entity="phialosophy", config={})
    DT = datetime.now()
...
for i in range(len(femur_no)):
    hr_paths_train.append(dataset_path + "femur_" + femur_no[i] + "/micro/volume/f_" + femur_no[i] + ".npy")
    if args.data_type == "real":
        lr_paths_train.append(dataset_path + "femur_" + femur_no[i] + "/clinical/volume/f_" + femur_no[i] + ".npy")
    else:
        lr_paths_train.append(dataset_path + "femur_" + femur_no[i] + "/synth/volume/f_" + femur_no[i] + ".npy")
    mask_paths_train.append(dataset_path + "femur_" + femur_no[i] + "/mask/volume/f_" + femur_no[i] + ".npy")
img_paths_train = []
...
for i in range(len(femur_no_test)):
    hr_paths_test.append(dataset_path + "femur_" + femur_no_test[i] + "/micro/volume/f_" + femur_no_test[i] + "_padded.npy")
    if args.data_type == "real":
        lr_paths_test.append(dataset_path + "femur_" + femur_no_test[i] + "/clinical/volume/f_" + femur_no_test[i] + "_padded.npy")
    else:
        lr_paths_test.append(dataset_path + "femur_" + femur_no_test[i] + "/synth/volume/f_" + femur_no_test[i] + "_padded.npy")
img_paths_test = []
...
num_samp_test = 0
for i in range(len(femur_no_test)):
    num_samp_test += SR_config.VOL_SHAPES[femur_no_test[i]][2]
