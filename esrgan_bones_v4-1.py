## Ver. 4.1: Changed input data to be 128x128x128 blocks
...
for i in range(len(femur_no)):
    hr_paths_train += sorted(glob.glob(dataset_path + "femur_" + femur_no[i] + "/micro/blocks_128/f_" + femur_no[i] + "*.*"))
    lr_paths_train += sorted(glob.glob(dataset_path + "femur_" + femur_no[i] + "/clinical/blocks_128/f_" + femur_no[i] + "*.*"))

hr_paths_test = sorted(glob.glob(dataset_path + "femur_" + femur_no_test + "/micro/blocks_128/f_" + femur_no_test + "*.*"))
lr_paths_test = sorted(glob.glob(dataset_path + "femur_" + femur_no_test + "/clinical/blocks_128/f_" + femur_no_test + "*.*"))
